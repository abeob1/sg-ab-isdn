---DROP PROCEDURE "AE_STOCKAGING_ISDN"
--- CALL "AE_STOCKAGING_ISDN_01" 

CREATE PROCEDURE "AE_STOCKAGING_ISDN" 
(
...
SELECT A.*, :AgingDate as AgingDate, B."InvDate", C."FrgnName" 
, (A."AgeColumn1"+ A."AgeColumn2"+ A."AgeColumn3"+ A."AgeColumn4"+ A."AgeColumn5") "QTY"
, (A."AgeColumn1_Value"+ A."AgeColumn2_Value"+ A."AgeColumn3_Value"+ A."AgeColumn4_Value"+ A."AgeColumn5_Value") "Amount"
	   ,:COMPNYADDR  AS COMPADD
	   ,:PHONE1 AS COMPTEL
	   ,:FAX AS COMPFAX
	  ,:EMAIL As E_Mail
 FROM Final A 
LEFT OUTER JOIN Invoice_Details B ON A."ItemCode" = B."ItemCode"
LEFT OUTER JOIN OITM C ON A."ItemCode" = C."ItemCode";

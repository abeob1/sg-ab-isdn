Create PROCEDURE "AE_OnTimeDelByCustomer_Sub"
(
 IN DateFrom DATE,
 IN DateTo DATE,
...
T0."CardCode",T0."CardName",count(T0."DocNum") as DL_No
 
 ,sum(case when DAYS_BETWEEN (IFNULL(T9."CfmDate",T5."DocDueDate"),T0."DocDate"  ) <=0 then 1

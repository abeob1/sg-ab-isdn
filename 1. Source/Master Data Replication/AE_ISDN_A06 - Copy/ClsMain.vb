...
Namespace AE_ISDN_A06
    Public Class ClsMain
        ...
        Public Sub New(ByRef oApp As SAPbouiCOM.Application)
        ...
        Public Sub AddMenuItems()
            ...
            Try
                ...
                oMenuItem = SBO_Application.Menus.Item("DRP")
                oMenus = oMenuItem.SubMenus
        ...
        Sub SBO_Application_MenuEvent(ByRef pVal As SAPbouiCOM.MenuEvent, ByRef BubbleEvent As Boolean) Handles SBO_Application.MenuEvent
            ...
            Try
                ...
                If (pVal.BeforeAction And pVal.MenuUID = "UDO_SYS") Then
                    ...
                    'SBO_Application.Menus.Item("SYSRATE").Activate()
                    'Dim oForm As SAPbouiCOM.Form = SBO_Application.OpenForm(SAPbouiCOM.BoFormObjectEnum.fo_UserDefinedObject, "SYSRATE", "")
        ...
        Sub SBO_Application_AppEvent(ByVal EventType As SAPbouiCOM.BoAppEventTypes) Handles SBO_Application.AppEvent
            ...
            End Try
        End Sub
        Public Shared Function FormExists(oApp As SAPbouiCOM.Application, formuid As String) As Boolean
            Try
                oApp.Forms.Item(formuid)
                Return True
